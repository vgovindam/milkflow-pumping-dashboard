...
try{
  ...
  if(failures.length){console.error(`Browser QA failed:\n- ${failures.join('\n- ')}`);process.exitCode=1;}else console.log('Browser QA passed 190 views: detailed theme worlds, independent Mom/Baby component art, Settings structure, navigation and light/dark surfaces are rendered from the production build.');
