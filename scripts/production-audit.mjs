...
const fail=[];
const must=['index.html','styles.css','theme.css','component-theme.css','component-theme-core.css','experience-themes.css','experience-system.css','doctor-summary.css','app.js','cross-device-alerts.js','experience-theme.js','sw.js','manifest.webmanifest','build-manifest.json'];
...
console.log(`Production audit passed for MilkFlow ${version}: canonical assets, service worker, data key, and notification contract are aligned.`);
