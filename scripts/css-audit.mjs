...
const cssFiles=['styles.css','component-theme-core.css',component,'experience-themes.css','experience-system.css','experience-components.css'].map(x=>typeof x==='string'&&x.endsWith('.css')?read(x):x);
...
const importantFiles=['styles.css','component-theme-core.css','component-theme.css','experience-themes.css','experience-system.css','experience-components.css','doctor-summary.css'];
