...
.mf-profile-line{display:flex;align-items:center;gap:12px;margin:0 0 14px}.mf-profile-line.has-summary{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:10px;align-items:center}.mf-profile-photo{width:64px;height:64px;border-radius:48% 52% 44% 56% / 46% 42% 58% 54%;overflow:hidden;flex:0 0 auto;background:var(--surface-2);display:grid;place-items:center;border:0;padding:0;color:var(--muted)}.mf-profile-photo img{width:100%;height:100%;object-fit:cover;display:block}.mf-profile-photo .placeholder{font-size:24px;line-height:1}.mf-profile-copy{min-width:0;flex:1}.mf-profile-copy .welcome{display:flex;align-items:center;gap:7px;font-size:12px;font-weight:800;color:var(--muted);margin-bottom:4px}.mf-profile-copy .welcome b{font-size:16px}.mf-profile-copy h2{margin:0;font:800 28px var(--display);letter-spacing:-.035em;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.mf-profile-copy small{display:block;margin-top:4px;color:var(--muted);font-size:10px;font-weight:650}.mf-profile-photo.addable{cursor:pointer}.mf-photo-hint{font-size:9px!important;color:var(--muted)!important}
.mf-top-orbs{display:flex;align-items:flex-start;justify-content:flex-end;gap:6px;min-width:0}.mf-top-orb-wrap{width:52px;text-align:center;min-width:0}.mf-top-orb{--p:100%;--orb-ring:#7b60d6;--orb-fill:#f4edff;position:relative;width:50px;height:50px;margin:auto;border-radius:50%;display:grid;align-content:center;justify-items:center;background:conic-gradient(var(--orb-ring) var(--p),rgba(120,126,150,.13) 0);isolation:isolate}.mf-top-orb::before{content:"";position:absolute;inset:4px;border-radius:50%;background:var(--orb-fill);z-index:-1}.mf-top-orb.plain{background:var(--orb-fill);box-shadow:inset 0 0 0 2px color-mix(in srgb,var(--orb-ring) 25%,transparent)}.mf-top-orb.plain::before{display:none}.mf-top-orb strong{font:850 13px var(--display);line-height:1;color:var(--ink);letter-spacing:-.03em;max-width:44px;overflow:hidden;text-overflow:ellipsis}.mf-top-orb small{margin-top:2px!important;font-size:7px!important;font-weight:800!important;line-height:1!important;color:var(--muted)!important}.mf-top-orb-wrap>span{display:block;margin-top:4px;font-size:7.5px;font-weight:850;color:var(--muted);white-space:nowrap}.mf-top-orb.mom-milk{--orb-ring:#7a56d6;--orb-fill:#f3eaff}.mf-top-orb.mom-goal{--orb-ring:#c46e9a;--orb-fill:#fff0f5}.mf-top-orb.mom-avg{--orb-ring:#49a28c;--orb-fill:#eaf8f2}.mf-top-orb.baby-milk{--orb-ring:#3e9dca;--orb-fill:#e7f5ff}.mf-top-orb.baby-usual{--orb-ring:#8670d6;--orb-fill:#f2ecff}.mf-top-orb.baby-diaper{--orb-ring:#4aa389;--orb-fill:#e7f8f1}
body[data-screen="mom-home"] .mom-hero .hero-copy>.eyebrow{display:none!important}
.mf-core-plan{margin:14px 0 17px;padding:17px 18px;border-radius:28px 42px 30px 38px / 34px 26px 42px 30px;background:var(--surface);border:1px solid var(--line-soft,var(--line));box-shadow:none}.mf-core-plan-head{display:flex;justify-content:space-between;gap:10px;align-items:center}.mf-core-plan-head strong{font-size:15px}.mf-core-plan-head span{font-size:10px;color:var(--muted);font-weight:800}.mf-core-next{font:800 24px var(--display);letter-spacing:-.03em;margin:12px 0 5px}.mf-core-sub{font-size:11px;color:var(--muted);line-height:1.4}.mf-core-times{display:flex;gap:7px;overflow:auto;margin-top:12px;scrollbar-width:none}.mf-core-time{flex:0 0 auto;padding:8px 11px;border-radius:999px;background:var(--surface-2);font-size:10.5px;font-weight:800}.mf-core-time.next{background:var(--mom);color:#fff}
.mf-core-baby{display:grid;gap:15px;margin-bottom:18px}.mf-core-baby .mf-profile-line{margin-bottom:0}.mf-care-label{display:flex;align-items:center;justify-content:space-between;margin:2px 2px -5px;font-size:10px;font-weight:850;letter-spacing:.04em;text-transform:uppercase;color:var(--muted)}.mf-care-label small{font-size:9px;font-weight:700;letter-spacing:0;text-transform:none}
.mf-feed-zone{display:grid;grid-template-columns:minmax(0,1.55fr) minmax(104px,.75fr);gap:11px;align-items:stretch}.mf-feed-main,.mf-feed-side button,.mf-diaper-blob,.mf-care-ribbon button{border:0;font:inherit;color:var(--ink);cursor:pointer;-webkit-tap-highlight-color:transparent}.mf-feed-main{position:relative;min-height:146px;padding:22px 20px;text-align:left;display:flex;flex-direction:column;justify-content:flex-end;overflow:hidden;border-radius:42% 58% 47% 53% / 56% 41% 59% 44%;background:linear-gradient(145deg,#dcecff 0%,#eef6ff 58%,#e9e6ff 100%);color:#294568}.mf-feed-main svg{position:absolute;right:17px;top:15px;width:55px;height:55px;fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;opacity:.78}.mf-feed-main strong{font-size:22px;font-weight:900;letter-spacing:-.025em}.mf-feed-main span{font-size:10.5px;font-weight:700;opacity:.72;margin-top:4px}.mf-feed-main em{position:absolute;left:18px;top:17px;font-size:9px;font-style:normal;font-weight:850;padding:5px 8px;border-radius:999px;background:rgba(255,255,255,.55)}
.mf-feed-side{display:grid;gap:9px}.mf-feed-side button{min-height:68px;padding:11px 12px;text-align:left;display:grid;grid-template-columns:34px 1fr;align-items:center;gap:8px;background:#edf5ff;color:#38536f}.mf-feed-side button:first-child{border-radius:58% 42% 49% 51% / 52% 62% 38% 48%}.mf-feed-side button:last-child{border-radius:44% 56% 60% 40% / 58% 43% 57% 42%;background:#f4f1ff;color:#544b74}.mf-feed-side svg{width:32px;height:32px;fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}.mf-feed-side strong{display:block;font-size:12px;font-weight:850}.mf-feed-side small{display:block;font-size:8.5px;opacity:.7;margin-top:2px}
.mf-diaper-cluster{display:grid;grid-template-columns:1fr 1fr 1fr;gap:9px;align-items:stretch}.mf-diaper-blob{position:relative;min-height:108px;padding:13px 10px 12px;text-align:center;display:flex;flex-direction:column;align-items:center;justify-content:flex-end}.mf-diaper-blob svg{position:absolute;top:13px;width:39px;height:39px;fill:none;stroke:currentColor;stroke-width:2.1;stroke-linecap:round;stroke-linejoin:round;opacity:.82}.mf-diaper-blob strong{font-size:13px;font-weight:900}.mf-diaper-blob span{font-size:9px;margin-top:3px;opacity:.72}.mf-diaper-blob b{position:absolute;right:10px;top:9px;min-width:22px;height:22px;padding:0 6px;border-radius:999px;background:rgba(255,255,255,.58);display:grid;place-items:center;font-size:9px}.mf-diaper-blob.wet{border-radius:56% 44% 62% 38% / 58% 46% 54% 42%;background:var(--wet);color:var(--wet-ink)}.mf-diaper-blob.poop{border-radius:42% 58% 45% 55% / 62% 45% 55% 38%;background:var(--poop);color:var(--poop-ink)}.mf-diaper-blob.both{border-radius:60% 40% 52% 48% / 43% 57% 44% 56%;background:var(--mixed);color:var(--mixed-ink)}
.mf-care-ribbon{display:flex;gap:8px;overflow:auto;scrollbar-width:none;padding:1px 1px 2px}.mf-care-ribbon::-webkit-scrollbar{display:none}.mf-care-ribbon button{flex:0 0 auto;display:flex;align-items:center;gap:7px;padding:9px 12px;border-radius:999px;background:var(--surface-2);font-size:10px;font-weight:800;color:var(--muted)}.mf-care-ribbon svg{width:17px;height:17px;fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}
...
@media(max-width:760px){#view{transition:none!important}.mf-core-plan{border-radius:24px 34px 25px 31px / 28px 23px 34px 26px}.mf-profile-photo{width:58px;height:58px}.mf-profile-copy h2{font-size:25px}.mf-feed-zone{grid-template-columns:minmax(0,1.5fr) minmax(98px,.78fr)}.mf-feed-main{min-height:136px;padding:20px 17px}.mf-feed-main strong{font-size:20px}.mf-diaper-blob{min-height:101px}.mf-care-ribbon button{padding:8px 11px}.mf-top-orb-wrap{width:48px}.mf-top-orb{width:46px;height:46px}.mf-top-orb strong{font-size:12px}}
@media(max-width:390px){.mf-profile-line.has-summary{grid-template-columns:auto minmax(0,1fr) auto;gap:7px}.mf-profile-photo{width:54px;height:54px}.mf-top-orbs{gap:3px}.mf-top-orb-wrap{width:43px}.mf-top-orb{width:42px;height:42px}.mf-top-orb strong{font-size:11px}.mf-top-orb-wrap>span{font-size:7px}.mf-feed-zone{grid-template-columns:1fr}.mf-feed-side{grid-template-columns:1fr 1fr}.mf-feed-side button{min-height:62px}.mf-diaper-cluster{gap:6px}.mf-diaper-blob{min-height:96px;padding-left:6px;padding-right:6px}}
`;
...
function renderMom(s){
  ...
  const greetNode=hero.querySelector('.greet');if(greetNode)greetNode.textContent='';
...
function renderBaby(s){
  ...
  const feedToday=st.milkCount+st.nursingCount+st.formulaCount,babyMeta=[age,!photo?'Tap the photo spot to add one':''].filter(Boolean).join(' · ');
  box.innerHTML=`
    <div class="mf-profile-line has-summary"><button type="button" class="mf-profile-photo addable" data-photo aria-label="${photo?'Change Baby photo':'Add Baby photo'}">${profilePhoto(photo,'baby')}</button><div class="mf-profile-copy"><div class="welcome"><b>${g.mark}</b><span>${g.text}</span></div><h2>${esc(babyName)}</h2>${babyMeta?`<small>${esc(babyMeta)}</small>`:''}</div><div class="mf-top-orbs" aria-label="Baby today summary">${topOrb(snap.todayOz.toFixed(1),'oz','Today','baby-milk',snap.pct,`${snap.todayOz.toFixed(1)} ounces from bottles today`)}${topOrb(snap.recentAvg?snap.pct:'—',snap.recentAvg?'%':'','Usual','baby-usual',snap.recentAvg?snap.pct:null,snap.recentAvg?`${snap.pct}% of recent daily average; ${snap.recentAvg.toFixed(1)} ounces recent average, ${snap.allAvg.toFixed(1)} overall`:'Comparison builds from logged days')}${topOrb(snap.diapers,'','Diapers','baby-diaper',null,`${st.wet} wet, ${st.poop} poopy, ${st.both} mixed today`)}</div></div>
...
window.addEventListener('hashchange',afterApp);window.addEventListener('popstate',afterApp);window.addEventListener('pageshow',afterApp);window.addEventListener('storage',e=>{if(e.key===STATE_KEY||e.key===COACH_KEY)afterApp();});window.addEventListener('milkflow:coach-change',afterApp);window.addEventListener('milkflow:chat-data',afterApp);
