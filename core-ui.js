...
.mf-dream-hero{min-height:0;padding:22px 24px;display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:20px;border-radius:32px!important;isolation:isolate;background:linear-gradient(135deg,#755fc8 0%,#9e78d9 36%,#e293bd 68%,#8fc5e8 100%)!important;border:0!important;box-shadow:0 22px 48px rgba(78,55,133,.2)!important;color:#fff;overflow:hidden}
.mf-dream-main h2{font:800 27px/1.06 var(--editorial);margin:9px 0 0;letter-spacing:-.02em}
.mf-dream-stats{display:flex;gap:16px;margin-top:13px;flex-wrap:wrap}
.mf-dream-stats span{display:grid;font-size:10.5px;font-weight:750;opacity:.86;line-height:1.2}
.mf-dream-stats strong{display:block;font:900 18px/1 var(--display);opacity:1;margin-bottom:2px}
...
.mf-dream-side{display:grid;justify-items:center;gap:7px}
...
.mf-dream-photo-cap{font-size:10.5px;font-weight:850;opacity:.9;letter-spacing:.02em}
...
.mf-dream-side{position:relative;z-index:2;display:grid;justify-items:center}.mf-dream-photo{width:136px;height:136px;padding:0;border:7px solid rgba(255,255,255,.22);border-radius:50%;overflow:hidden;background:linear-gradient(145deg,rgba(255,255,255,.93),rgba(235,215,255,.93));color:#4a2f86;display:grid;place-items:center;box-shadow:0 18px 34px rgba(57,37,101,.16)}.mf-dream-photo img{width:100%;height:100%;object-fit:cover}.mf-dream-photo .placeholder{font-size:38px}
...
:root[data-theme="dark"] .mf-dream-hero{background:linear-gradient(145deg,#29204d 0%,#493166 40%,#693a61 69%,#274e69 100%)!important}:root[data-theme="dark"] .mf-dream-journey{background:rgba(28,28,48,.86)!important;border-color:rgba(200,185,245,.12)!important}:root[data-theme="dark"] .mf-journey-stop i{border-color:#26243d;background:#34304c}:root[data-theme="dark"] .mf-journey-stop.done i{background:#173f33}:root[data-theme="dark"] .mf-dream-metrics .metric{background:rgba(31,31,51,.84)}
:root[data-theme="dark"] .mf-journey-stop i{color:#d5c9ec}:root[data-theme="dark"] .mf-journey-stop.done i{color:#8ee4c4}:root[data-theme="dark"] .mf-journey-head em{background:#33274d;color:#dbcaff}:root[data-theme="dark"] .mf-dream-journey>p,:root[data-theme="dark"] .mf-journey-stop small{color:#c0c7d8!important}
...
@media(max-width:760px){
  ...
  .mf-dream-hero{min-height:0;padding:18px 17px;border-radius:29px!important;gap:16px}.mf-dream-main{display:block;max-width:none}.mf-dream-welcome{min-height:26px;padding-right:130px;font-size:11.5px}.mf-dream-welcome>span{width:25px;height:25px}.mf-dream-kicker{margin-top:37px;font-size:9px}.mf-dream-main h2{max-width:none;font-size:25px;line-height:1.06;margin:8px 0 0}.mf-dream-main>p{display:none}.mf-dream-next{width:100%;margin-top:15px;padding:11px 11px 11px 14px;border-radius:19px;gap:9px}.mf-dream-next>div strong{font-size:16px}.mf-dream-next>div small{font-size:9px}.mf-dream-next button{min-height:48px;width:auto;min-width:91px;padding:0 12px;justify-content:center;border-radius:15px}.mf-dream-next button span{display:inline;font-size:10px}.mf-dream-side{position:absolute;top:12px;right:13px;display:block;width:118px;height:132px}.mf-dream-photo{width:92px;height:92px;border-width:5px}.mf-dream-photo .placeholder{font-size:32px}.mf-dream-journey{padding:17px 15px!important}.mf-journey-track{margin-top:14px;grid-auto-columns:82px}.mf-dream-actions .quick-tile{min-height:116px;padding:58px 13px 15px}.mf-dream-actions .quick-tile strong{font-size:19px}.mf-dream-actions .quick-tile .tile-art{width:54px;height:54px}
...
function renderMom(s){
  ...
  hero.innerHTML=`
    <div class="mf-dream-main">
      ...
      <div class="mf-dream-stats" aria-label="Today at a glance">
        <span><strong>${snap.total}</strong>mL today</span>
        <span><strong>${x.actual.length}/${x.target}</strong>pumps</span>
        <span><strong>${x.last?`${Number(x.last.amountMl)||0} mL`:'—'}</strong>last pump</span>
      </div>
    ...
    <div class="mf-dream-side">
      ...
      <span class="mf-dream-photo-cap">${x.actual.length} of ${x.target}</span>
    </div>`;
...
function renderBaby(s){
  ...
  box.innerHTML=`
    ...
    <div class="mf-animal-checkin" aria-label="Last feeding">
      ...
      <span class="mf-last-feed-age"><strong>${nextFeed?esc(nextFeed.label):esc(lf.age)}</strong><small>${nextFeed?(nextFeed.overdue?'Feed due':'Next feed'):'Last fed'}</small></span>
    </div>
