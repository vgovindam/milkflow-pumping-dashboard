...
.mf-animal-stats{position:absolute;z-index:3;top:18px;right:19px;display:grid;gap:7px}.mf-animal-stat{min-width:92px;padding:8px 11px;border:1px solid rgba(255,255,255,.55);border-radius:15px;background:rgba(255,255,255,.56);backdrop-filter:blur(12px);text-align:right}.mf-animal-stat strong,.mf-animal-stat span{display:block}.mf-animal-stat strong{font:900 15px var(--display)}.mf-animal-stat span{margin-top:2px;font-size:9px;font-weight:850;opacity:.68;text-transform:uppercase;letter-spacing:.06em}
...
.mf-diaper-blob>.mf-animal-sticker{position:absolute;top:6px;left:50%;transform:translateX(-50%);width:60px;height:60px;padding:5px;border-radius:50%;background:rgba(255,255,255,.38);box-shadow:inset 0 1px 0 rgba(255,255,255,.58)}.mf-diaper-blob>.mf-animal-sticker svg{position:static;width:100%;height:100%;transform:none;fill:initial;stroke:initial;opacity:1}
...
@media(max-width:760px){
  ...
  .mf-animal-hero{min-height:184px;padding:16px;border-radius:29px 36px 28px 34px / 33px 28px 37px 30px}.mf-animal-profile{display:block;width:100%;height:122px;max-width:none}.mf-animal-profile .mf-profile-photo{width:108px;height:108px;border-width:6px}.mf-animal-copy{position:absolute;left:121px;top:18px;width:102px}.mf-animal-copy h2{font-size:25px}.mf-animal-copy small{font-size:9.5px}.mf-animal-stats{top:13px;right:12px;gap:5px}.mf-animal-stat{min-width:75px;padding:6px 7px}.mf-animal-stat strong{font-size:13px}.mf-animal-stat span{font-size:7.5px}.mf-animal-hero>.bear{width:68px;height:68px;right:82px;bottom:0}.mf-animal-hero>.bunny{width:55px;height:55px;right:23px;bottom:3px}.mf-animal-star.one{left:47%;top:23px}.mf-animal-checkin{grid-template-columns:44px minmax(0,1fr) auto;padding:10px 11px}.mf-animal-checkin>.mf-animal-sticker{width:42px;height:42px}
