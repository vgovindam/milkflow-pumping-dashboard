...
.mf-core-baby{display:grid;gap:15px;margin-bottom:18px}.mf-core-baby .mf-profile-line{margin-bottom:0}.mf-care-label{display:flex;align-items:center;justify-content:space-between;margin:2px 2px -5px;font-size:11.5px;font-weight:850;letter-spacing:.035em;text-transform:uppercase;color:var(--muted)}.mf-care-label small{font-size:10.5px;font-weight:700;letter-spacing:0;text-transform:none}
.mf-last-feed-band{display:grid;grid-template-columns:34px minmax(0,1fr) minmax(116px,auto);gap:10px;align-items:center;margin:-2px 0 1px;padding:12px 13px;border-radius:18px;background:linear-gradient(135deg,#e8f6ff,#eef7ff 55%,#eef9f5);border:1px solid #d5e9f0;color:#38536f}.mf-last-feed-band .mf-last-feed-icon{width:34px;height:34px;border-radius:12px;background:rgba(255,255,255,.72);display:grid;place-items:center}.mf-last-feed-band svg{width:21px;height:21px;fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}.mf-last-feed-primary,.mf-last-feed-age{min-width:0}.mf-last-feed-band strong{display:block;font-size:14.5px;line-height:1.15;font-weight:900;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.mf-last-feed-band small{display:block;margin-top:4px;font-size:10.5px;line-height:1.2;color:var(--muted);font-weight:750}.mf-last-feed-age{text-align:right}.mf-last-feed-age strong{font-size:14.5px}.mf-last-feed-age small{font-size:9.5px;text-transform:uppercase;letter-spacing:.04em}
...
:root[data-theme="dark"] .mf-top-orb.mom-pumps{--orb-ring:#b795ff;--orb-fill:#2b2344}:root[data-theme="dark"] .mf-top-orb.mom-goal{--orb-ring:#ef9fbe;--orb-fill:#3a2432}:root[data-theme="dark"] .mf-top-orb.mom-avg{--orb-ring:#73d2b6;--orb-fill:#17382f}:root[data-theme="dark"] .mf-top-orb.baby-milk{--orb-ring:#69c8f2;--orb-fill:#173447}:root[data-theme="dark"] .mf-top-orb.baby-usual{--orb-ring:#b09af5;--orb-fill:#2b2443}:root[data-theme="dark"] .mf-top-orb.baby-diaper{--orb-ring:#70d0b3;--orb-fill:#17372e}:root[data-theme="dark"] .mf-top-orb strong{color:#f7f9ff;text-shadow:0 1px 1px rgba(0,0,0,.22)}:root[data-theme="dark"] .mf-top-orb small{color:#d4dae6!important}:root[data-theme="dark"] .mf-top-orb-wrap>span{color:#cbd1dc}:root[data-theme="dark"] .mf-last-feed-band{background:linear-gradient(135deg,#152634,#182635 55%,#142c28);border-color:#29434f;color:#edf7ff}:root[data-theme="dark"] .mf-last-feed-band .mf-last-feed-icon{background:#1d3542;color:#89d5f0}:root[data-theme="dark"] .mf-last-feed-band small{color:#b4bdca}:root[data-theme="dark"] .mf-feed-main{background:linear-gradient(145deg,#172b3c 0%,#1a2638 58%,#28223c 100%);color:#d9edff}:root[data-theme="dark"] .mf-feed-main em{background:rgba(255,255,255,.1);color:#e9f3ff}:root[data-theme="dark"] .mf-feed-side button{background:#172634;color:#d2e7f5}:root[data-theme="dark"] .mf-feed-side button:last-child{background:#272239;color:#e1d9ff}:root[data-theme="dark"] .mf-diaper-blob b{background:#252b36;color:#f7f8fc;box-shadow:0 0 0 1px rgba(255,255,255,.08)}:root[data-theme="dark"] .mf-care-ribbon button{color:#c7cedb}:root[data-theme="dark"] .mf-core-time{color:#eef1f7;border:1px solid var(--line)}:root[data-theme="dark"] .mf-mom-hero-photo{box-shadow:0 0 0 6px rgba(169,138,240,.2),0 10px 24px rgba(0,0,0,.35)}
...
@media(max-width:760px){#view{transition:none!important}.mf-core-plan{border-radius:24px 34px 25px 31px / 28px 23px 34px 26px}.mf-profile-photo{width:60px;height:60px}.mf-profile-copy h2{font-size:27px}.mf-feed-zone{grid-template-columns:minmax(0,1.5fr) minmax(100px,.78fr)}.mf-feed-main{min-height:138px;padding:20px 17px}.mf-feed-main strong{font-size:22px}.mf-diaper-blob{min-height:104px}.mf-care-ribbon button{padding:9px 12px}.mf-top-orb-wrap{width:50px}.mf-top-orb{width:48px;height:48px}.mf-top-orb strong{font-size:13px}.mf-mom-orbs{margin-top:4px}.ring.mf-mom-photo-ring,.mf-mom-hero-photo{width:116px;height:116px}}
@media(max-width:390px){.mf-profile-line.has-summary{grid-template-columns:auto minmax(0,1fr) auto;gap:7px}.mf-profile-photo{width:54px;height:54px}.mf-profile-copy .welcome{font-size:12.5px}.mf-profile-copy h2{font-size:25px}.mf-profile-copy small{font-size:10.5px}.mf-top-orbs{gap:3px}.mf-top-orb-wrap{width:44px}.mf-top-orb{width:43px;height:43px}.mf-top-orb strong{font-size:12px}.mf-top-orb small{font-size:8px!important}.mf-top-orb-wrap>span{font-size:7.7px}.mf-mom-orbs{gap:5px}.mf-mom-orbs .mf-top-orb-wrap{width:50px}.mf-mom-orbs .mf-top-orb{width:47px;height:47px}.ring.mf-mom-photo-ring,.mf-mom-hero-photo{width:104px;height:104px}.mf-last-feed-band{grid-template-columns:30px minmax(0,1fr) minmax(104px,auto);gap:8px;padding:10px}.mf-last-feed-band strong,.mf-last-feed-age strong{font-size:13px}.mf-last-feed-band small{font-size:9.5px}.mf-feed-zone{grid-template-columns:1fr}.mf-feed-side{grid-template-columns:1fr 1fr}.mf-feed-side button{min-height:66px}.mf-diaper-cluster{gap:6px}.mf-diaper-blob{min-height:100px;padding-left:6px;padding-right:6px}}
`;
...
function renderMom(s){
  ...
  let prof=document.getElementById('mfMomProfileLine');if(!prof){prof=document.createElement('div');prof.id='mfMomProfileLine';const copy=hero.querySelector('.hero-copy')||hero;copy.prepend(prof);}prof.className='mf-profile-line mf-mom-copy-line';
  ...
  let orbs=document.getElementById('mfMomOrbs');if(!orbs){orbs=document.createElement('div');orbs.id='mfMomOrbs';orbs.className='mf-mom-orbs';prof.insertAdjacentElement('afterend',orbs);}orbs.innerHTML=`${topOrb(`${snap.pumps}/${snap.target}`,'','Pumps','mom-pumps',snap.target?snap.pumps/snap.target*100:null,'Pumps completed today')}${topOrb(snap.pct,'%','Goal','mom-goal',snap.pct,`${snap.pct}% of daily goal`)}${topOrb(snap.avg||'—','mL','7d avg','mom-avg',null,'Seven day pumping average')}`;
...
function renderBaby(s){
  ...
  box.innerHTML=`
    <div class="mf-profile-line has-summary"><button type="button" class="mf-profile-photo addable" data-photo aria-label="${photo?'Change Baby photo':'Add Baby photo'}">${profilePhoto(photo,'baby')}</button><div class="mf-profile-copy"><div class="welcome"><b>${g.mark}</b><span>${g.text}</span></div><h2>${esc(babyName)}</h2>${babyMeta?`<small>${esc(babyMeta)}</small>`:''}</div><div class="mf-top-orbs" aria-label="Baby today summary">${topOrb(snap.todayOz.toFixed(1),'oz','Today','baby-milk',snap.pct,`${snap.todayOz.toFixed(1)} ounces from bottles today`)}${topOrb(snap.recentAvg?snap.pct:'—',snap.recentAvg?'%':'','Vs avg','baby-usual',snap.recentAvg?snap.pct:null,snap.recentAvg?`${snap.pct}% of recent daily average; ${snap.recentAvg.toFixed(1)} ounces recent average, ${snap.allAvg.toFixed(1)} overall`:'Comparison builds from logged days')}${topOrb(snap.diapers,'','Diapers','baby-diaper',null,`${st.wet} wet, ${st.poop} poopy, ${st.both} mixed today`)}</div></div>
    <div class="mf-last-feed-band" aria-label="Last feeding"><span class="mf-last-feed-icon">${icon('bottle')}</span><span class="mf-last-feed-primary"><strong>${esc(lf.main)}</strong><small>${esc(lf.clock)}</small></span><span class="mf-last-feed-age"><strong>${esc(lf.age)}</strong><small>Last fed</small></span></div>
    <div class="mf-care-label"><span>Feed</span><small>Quick log</small></div>
    <div class="mf-feed-zone">
      <button type="button" class="mf-feed-main" data-feed-type="expressed_milk" aria-label="Log breast milk bottle">${icon('bottle')}<em>Your usual</em><strong>Breast milk</strong><span>Tap to log a bottle</span></button>
...
function cleanup(){if(document.body.dataset.screen!=='mom-home'){document.getElementById('mfCorePlan')?.remove();document.getElementById('mfMomProfileLine')?.remove();document.getElementById('mfMomOrbs')?.remove();}if(document.body.dataset.screen!=='baby-home')document.getElementById('mfCoreBaby')?.remove();}
