...
/* Anchor near the top: a portrait centred in a circle loses the top of the head. */
.mf-profile-photo img{width:100%;height:100%;object-fit:cover;object-position:50% 18%;display:block}.mf-profile-photo .placeholder{font-size:26px;line-height:1;color:#6b7284}
...
.mf-dream-stats span{display:grid;font-size:11.5px;font-weight:750;opacity:.9;line-height:1.2}
.mf-dream-stats strong{display:block;font:900 20px/1 var(--display);opacity:1;margin-bottom:3px}
...
.mf-dream-side{position:relative;z-index:2;display:grid;justify-items:center}.mf-dream-photo{width:136px;height:136px;padding:0;border:7px solid rgba(255,255,255,.22);border-radius:50%;overflow:hidden;background:linear-gradient(145deg,rgba(255,255,255,.93),rgba(235,215,255,.93));color:#4a2f86;display:grid;place-items:center;box-shadow:0 18px 34px rgba(57,37,101,.16)}.mf-dream-photo img{width:100%;height:100%;object-fit:cover;object-position:50% 18%}.mf-dream-photo .placeholder{font-size:38px}
.mf-dream-journey{position:relative;z-index:3;margin-top:18px;padding:23px 25px;border-radius:30px;background:rgba(255,255,255,.82);box-shadow:0 18px 40px rgba(79,63,132,.11),inset 0 1px 0 #fff}.mf-journey-head{display:flex;align-items:center;justify-content:space-between;gap:16px}.mf-journey-head span,.mf-journey-head strong{display:block}.mf-journey-head span{font-size:9px;letter-spacing:.15em;font-weight:900;color:var(--mom)}.mf-journey-head strong{margin-top:4px;font:800 18px var(--display)}.mf-journey-head em{font-style:normal;padding:7px 11px;border-radius:999px;background:var(--mom-soft);color:var(--mom-ink);font-size:11px;font-weight:900}.mf-journey-track{position:relative;display:grid;grid-auto-flow:column;grid-auto-columns:minmax(92px,1fr);gap:8px;overflow:auto;margin:14px 0 8px;padding:12px 0 10px;scrollbar-width:none}.mf-journey-track:before{content:"";position:absolute;left:34px;right:34px;top:33px;height:2px;background:linear-gradient(90deg,#8b68de,#e19ac2,#8bc9e7);opacity:.27}.mf-journey-stop{position:relative;z-index:1;display:grid;justify-items:center;min-width:92px;text-align:center}.mf-journey-stop i{width:44px;height:44px;border-radius:50%;display:grid;place-items:center;background:#f2edfb;color:#63558a;border:5px solid rgba(255,255,255,.9);box-shadow:0 4px 14px rgba(82,64,131,.1);font-style:normal}.mf-journey-stop.done i{background:#dff5ec;color:#258165}.mf-journey-stop.next i{background:linear-gradient(145deg,#6a45c2,#a4457f);color:#fff;box-shadow:0 7px 18px rgba(115,75,178,.26),0 0 0 4px rgba(132,98,216,.1)}.mf-journey-stop strong{margin-top:7px;font-size:12px}.mf-journey-stop small{margin-top:2px;font-size:9px;color:var(--muted);font-weight:800}.mf-dream-journey>p{margin:2px 0 0;color:var(--muted);font-size:11px;line-height:1.45}
...
@media(max-width:760px){
  ...
  .mf-dream-hero{min-height:0;padding:18px 17px;border-radius:29px;gap:16px}.mf-dream-main{display:block;max-width:none}.mf-dream-welcome{min-height:26px;padding-right:126px;font-size:11.5px;white-space:nowrap}.mf-dream-welcome>span{width:25px;height:25px}.mf-dream-kicker{margin-top:37px;font-size:9px}.mf-dream-main h2{max-width:none;font-size:27px;line-height:1.08;margin:9px 0 0}.mf-dream-main>p{display:none}.mf-dream-next{width:100%;margin-top:15px;padding:11px 11px 11px 14px;border-radius:19px;gap:9px}.mf-dream-next>div strong{font-size:16px}.mf-dream-next>div small{font-size:9px}.mf-dream-next button{min-height:48px;width:auto;min-width:91px;padding:0 12px;justify-content:center;border-radius:15px}.mf-dream-next button span{display:inline;font-size:10px}.mf-dream-side{position:absolute;top:12px;right:13px;display:block;width:118px;height:132px}.mf-dream-photo{width:116px;height:116px;border-width:5px}.mf-dream-photo .placeholder{font-size:32px}.mf-dream-journey{padding:17px 15px}.mf-journey-track{margin-top:14px;grid-auto-columns:82px}.mf-dream-actions .quick-tile{min-height:116px;padding:58px 13px 15px}.mf-dream-actions .quick-tile strong{font-size:19px}.mf-dream-actions .quick-tile .tile-art{width:54px;height:54px}
...
@media(max-width:760px){
  ...
  .mf-animal-copy .welcome{font-size:11px;line-height:1.25;letter-spacing:.01em}.mf-animal-copy h2{font-size:27px}.mf-animal-copy small{font-size:11px;line-height:1.25}.mf-animal-stat strong{font-size:14px}.mf-animal-stat span{font-size:10px;line-height:1.2}.mf-care-label{font:750 15px/1.2 var(--display);letter-spacing:-.01em}.mf-care-label small{font-size:12px;color:var(--ink-2)}.mf-animal-checkin strong{font-size:15px}.mf-animal-checkin small{font-size:11px;opacity:.9}.mf-feed-card strong{font-size:15px;font-weight:800}.mf-feed-card small,.mf-diaper-blob span{font-size:11px}.mf-diaper-blob strong{font-size:16px}
...
function renderBaby(s){
  ...
  box.innerHTML=`
    ...
    <div class="mf-animal-checkin" aria-label="Last feeding">
      ${careMark('clock')}
      <span class="mf-last-feed-primary"><strong>${esc(lf.main)}</strong><small>${esc(lf.age)}${lf.clock&&lf.clock!=='Tap a feed option below'?` · ${esc(lf.clock)}`:''}</small></span>
