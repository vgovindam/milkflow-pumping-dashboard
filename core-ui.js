...
.mf-profile-photo img{width:100%;height:100%;object-fit:cover;object-position:50% 18%;display:block}.mf-profile-photo .placeholder{font-size:26px;line-height:1}
...
.mf-hero-fact{display:grid;align-content:start;gap:2px;min-width:0;padding:10px 12px;border-radius:18px;
...
.mf-hero-fact strong{font:800 17px/1.12 var(--display);letter-spacing:-.01em;overflow-wrap:anywhere}
...
.mf-dream-side{display:contents}.mf-dream-photo{width:136px;height:136px;padding:0;border:7px solid rgba(255,255,255,.22);border-radius:50%;overflow:hidden;background:linear-gradient(145deg,rgba(255,255,255,.93),rgba(235,215,255,.93));color:#4a2f86;display:grid;place-items:center;box-shadow:0 18px 34px rgba(57,37,101,.16)}.mf-dream-photo img{width:100%;height:100%;object-fit:cover;object-position:50% 18%}.mf-dream-photo .placeholder{font-size:38px}
...
@media(max-width:760px){
  ...
  .mf-dream-hero{min-height:0;padding:16px 16px 18px;border-radius:29px;grid-template-columns:minmax(0,1fr) 128px;grid-template-areas:"greeting photo" "title photo" "facts facts" "next next";align-items:start;column-gap:14px;row-gap:0}.mf-dream-main,.mf-dream-side{display:contents}.mf-dream-welcome{grid-area:greeting;min-height:0;padding:0;font-size:15px;align-self:center;min-width:0}.mf-dream-welcome>b{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.mf-dream-welcome>span{width:25px;height:25px}.mf-dream-kicker{margin-top:0;font-size:9px}.mf-dream-main h2{grid-area:title;max-width:none;font-size:22px;line-height:1.12;margin:7px 0 0;align-self:start;text-wrap:balance}.mf-dream-main>p{display:none}.mf-dream-next{grid-area:next;width:100%;margin-top:11px;padding:11px 11px 11px 14px;border-radius:19px;gap:9px}.mf-dream-next>div strong{font-size:16px}.mf-dream-next>div small{font-size:9px}.mf-dream-next button{min-height:48px;width:auto;min-width:91px;padding:0 12px;justify-content:center;border-radius:15px}.mf-dream-next button span{display:inline;font-size:10px}.mf-dream-photo{grid-area:photo;align-self:center;justify-self:end;width:128px;height:128px;border-width:6px}.mf-hero-facts{grid-area:facts;margin-top:13px}.mf-dream-photo .placeholder{font-size:32px}.mf-dream-journey{padding:17px 15px}.mf-journey-track{margin-top:14px;grid-auto-columns:82px}.mf-dream-actions .quick-tile{min-height:116px;padding:58px 13px 15px}.mf-dream-actions .quick-tile strong{font-size:19px}.mf-dream-actions .quick-tile .tile-art{width:54px;height:54px}
...
@media(max-width:390px){
  ...
  .mf-dream-hero{min-height:0;padding-left:16px;padding-right:16px;grid-template-columns:minmax(0,1fr) 116px;column-gap:12px}.mf-dream-photo{width:116px;height:116px}.mf-dream-welcome{font-size:13.5px}.mf-dream-main h2{font-size:27px}.mf-dream-next>div strong{font-size:16px}.mf-dream-next>div small{max-width:190px}.mf-journey-head strong{font-size:16px}
  ...
  hero.innerHTML=`
    <div class="mf-dream-main">
      ...
      <div class="mf-hero-facts" aria-label="Today at a glance">
        ...
        <span class="mf-hero-fact"><small>Today</small><strong>${snap.total} mL</strong><em>${x.actual.length} of ${x.target} pumps</em></span>
      </div>
  ...
  box.innerHTML=`
    <div class="mf-animal-hero">
      ...
      <div class="mf-hero-facts" aria-label="Baby today summary">
        <span class="mf-hero-fact"><small>Last feed</small><strong>${esc(lf.main)}</strong><em>${esc(lf.age==='—'?'Nothing logged yet':lf.age)}</em></span>
