...
.mf-dream-kicker{margin-top:34px;font-size:11px;letter-spacing:.19em;font-weight:900;color:#fff2c5}.mf-dream-main h2{max-width:580px;margin:7px 0 9px;font:850 clamp(38px,4vw,58px)/.98 var(--display);letter-spacing:-.045em;color:#fff!important;text-wrap:balance;text-shadow:0 2px 16px rgba(61,39,103,.14)}.mf-dream-main>p{max-width:560px;margin:0;color:rgba(255,255,255,.82);font-size:15px;line-height:1.55}
...
.mf-animal-profile{position:relative;z-index:2;display:flex;align-items:center;gap:14px;max-width:62%}.mf-animal-profile .mf-profile-photo{width:88px;height:88px;border:5px solid rgba(255,255,255,.72);background:#fff6e4;box-shadow:0 10px 24px rgba(38,99,102,.14)}.mf-animal-copy .welcome{font-size:11px;font-weight:900;letter-spacing:.08em;text-transform:uppercase;opacity:.72}.mf-animal-copy h2{margin:3px 0 0;font:850 28px/.98 var(--display);letter-spacing:-.035em}.mf-animal-copy small{display:block;margin-top:6px;font-size:11px;font-weight:800;opacity:.72}
.mf-animal-stats{position:absolute;z-index:3;top:18px;right:19px;display:grid;gap:7px}.mf-animal-stat{min-width:92px;padding:8px 11px;border:1px solid rgba(255,255,255,.72);border-radius:15px;background:rgba(255,255,255,.7);backdrop-filter:blur(12px);text-align:right}.mf-animal-stat:first-child{background:linear-gradient(145deg,rgba(218,244,255,.94),rgba(178,227,248,.9));color:#15516d}.mf-animal-stat:last-child{background:linear-gradient(145deg,rgba(255,243,203,.95),rgba(255,218,169,.9));color:#74451b}.mf-animal-stat strong,.mf-animal-stat span{display:block}.mf-animal-stat strong{font:900 15px var(--display)}.mf-animal-stat span{margin-top:2px;font-size:9px;font-weight:900;opacity:.82;text-transform:uppercase;letter-spacing:.06em}
...
function renderMom(s){
  ...
  hero.innerHTML=`
    ...
    <div class="mf-dream-main">
      ...
      <div class="mf-dream-kicker">TODAY AT A GLANCE</div>
      <h2>${x.remaining?'Your pumping day at a glance':'Today is complete'}</h2>
