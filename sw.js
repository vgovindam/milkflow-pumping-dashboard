...
const VERSION = 'milkflow-stable45-baby3';
const SHELL = [
  './', './index.html', './styles.css', './care-polish.css', './layout-fixes.css', './stable34-bridge.js', './app.js', './app-reliability.js', './core-ui.js', './baby-experience.js', './ai-coach-client.js', './app-update-notice.js', './family-chat.js', './config.js',
