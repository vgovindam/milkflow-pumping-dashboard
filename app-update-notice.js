...
function injectStyle(){
  ...
  .app-update-notice{position:fixed;left:50%;bottom:calc(124px + env(safe-area-inset-bottom));transform:translateX(-50%);z-index:9999;width:min(92vw,430px);display:flex;align-items:center;justify-content:space-between;gap:12px;padding:12px 13px 12px 15px;border-radius:18px;background:var(--ink);color:var(--on-ink,#fff);box-shadow:0 14px 38px rgba(20,25,40,.25)}
